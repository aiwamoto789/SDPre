...
public class DictionaryOrder {
  public static void main( String[] args) {
    ...
    String changeCase = name;
    name = changeCase.toLowerCase();

    if ( name.compareTo("c++") < 0 )
      System.out.println( name + " comes BEFORE c++" );
    if ( name.compareTo("c++") == 0 )
      System.out.println( name + "c++ isnt a made-up language!" );
    if ( name.compareTo("c++") > 0 )
    ...
    if ( name.compareTo("go") == 0 )
        System.out.println( name + "go isnt a made-up language!" );
    if ( name.compareTo("go") > 0 )
    ...
    if ( name.compareTo("java") == 0 )
      System.out.println( name + "java isnt a made-up language!" );
    if ( name.compareTo("java") > 0 )
    ...
    if ( name.compareTo("lisp") == 0 )
      System.out.println( name + "lisp isnt a made-up language!" );
    if ( name.compareTo("lisp") > 0 )
    ...
    if ( name.compareTo("python") == 0 )
      System.out.println( name + "python isnt a made-up language!" );
    if ( name.compareTo("python") > 0 )
    ...
    if ( name.compareTo("ruby") == 0 )
      System.out.println( name + "ruby isnt a made-up language!" );
    if ( name.compareTo("ruby") > 0 )
    ...
    if ( name.compareTo("visualbasic") == 0 )
      System.out.println( name + "visualbasic isnt a made-up language!" );
    if ( name.compareTo("visualbasic") > 0 )
